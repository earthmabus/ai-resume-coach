...
Documents under `history/` are retained for project chronology. They are not
authoritative descriptions of the current platform.

## Archive

- [Archived engineering material](archive/README.md)
